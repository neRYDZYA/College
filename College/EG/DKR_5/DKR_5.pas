...
begin
  ...
  ReadDataFromFile('C:\Users\raydi\OneDrive\Desktop\dkr5\int.txt', inputData, count);
   ...
   WriteDataToFile('C:\Users\raydi\OneDrive\Desktop\dkr5\out1.txt', countingData, count); 
   time2 := Milliseconds;
   ...
   time4 := Milliseconds; 
   WriteDataToFile('C:\Users\raydi\OneDrive\Desktop\dkr5\out2.txt', heapData, count);
